document.addEventListener('DOMContentLoaded', () => {
    ...
    const gameFieldVisibility=document.querySelector('#gameFieldVisibility')
    const footerVisibility=document.querySelector('#footerVisibility')
    ...
    //draw the computer ship ramdome location
    ...
    closeButton.addEventListener('click',()=>{
      instruction.remove();
      footerVisibility.style.visibility="visible";
      gameFieldVisibility.style.visibility="visible";
      StartButton.remove();
    });
